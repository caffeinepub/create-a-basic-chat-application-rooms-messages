        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-baseline gap-2 mb-1">
              <button
                onClick={() => setShowProfileViewer(true)}
                className="font-medium text-sm text-foreground hover:underline focus:outline-none focus:underline"
              >
      ...
      <div className="flex h-full items-center justify-center bg-background p-8">
        <div className="text-center max-w-md">
          <img 
            ...
            alt="TerrorChat - No room selected" 
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="border-b border-border bg-card px-6 py-4 flex items-center justify-between">
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'chat' | 'voice')} className="flex-1">
